 ...
 ?>
  ...
  <form name="sphca_form" method="post" action="<?php echo $mainurl; ?>" onsubmit="return _sphca_submit()"  >
    <table width="100%" border="0" cellspacing="4" cellpadding="4">
      ...
      <tr>
        <td colspan="2"><textarea name="sphca_text" id="sphca_text" cols="120" rows="10"><?php echo $sphca_text_x; ?></textarea></td>
      </tr>
      <tr>
      ...
      <table width="100%" class="widefat" id="straymanage">
        ...
        <tbody>
          <tr class="<?php if ($i&1) { echo'alternate'; } else { echo ''; }?>">
            ...
            <td align="left" valign="middle">[SPHCA-POPUP:<?php echo(stripslashes($data->sphca_id)); ?>]</td>
