...
if($wpdb->get_var("show tables like '". wp_scroll_popup_html_content_ads_table . "'") != wp_scroll_popup_html_content_ads_table) 
{
	...
	$c1 = '<p align="left"><img style="margin: 5px;text-align:left;float:left;" title="Gopi" src="http://www.gopiplus.com/work/wp-content/uploads/2011/01/gopiplus.com-popup.png" alt="Gopi" />This is the demo for cool fade popup plugin. using this plugin you can add this cool popup window into your wordpress website. using this unblockable popup window  you can add your ads, special information, offers and announcements. Close this popup and read the article you can easily configure this plugin in your wordpress website. its very simple. please feel free to post you comments and feedback.</p>';
	$t1 = 'Popup Title';
