...
if($wpdb->get_var("show tables like '". wp_scroll_popup_html_content_ads_table . "'") != wp_scroll_popup_html_content_ads_table) 
{
	...
	$c1 = '<p align="left"><img style="margin: 5px;text-align:left;float:left;" title="Gopi" src="'.get_option('siteurl').'/wp-content/plugins/scroll-popup-html-content-ads/gopipulse.com-popup.png" alt="Gopi" />This is the demo for cool fade popup plugin. using this plugin you can add this cool popup window into your wordpress website. using this unblockable popup window  you can add your ads, special information, offers and announcements. Close this popup and read the article you can easily configure this plugin in your wordpress website. its very simple. please feel free to post you comments and feedback.</p>';
	$t1 = 'Popup Title';
	$c2 = '<a href="http://www.gopipulse.com/work/" target="_blank"><img src="'.get_option('siteurl').'/wp-content/plugins/scroll-popup-html-content-ads/gopiplus.jpg" border="0"  /></a>';
