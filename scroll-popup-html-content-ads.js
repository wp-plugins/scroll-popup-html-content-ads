...
function sphca_loadpopup(width, height, title, htmlCode)
{
    ...
    document.write('<div id="postit_title" class="title"><b>' + _title + ' <span class="spantitle"><img src="http://www.gopipulse.com/work/wp-content/plugins/scroll-popup-html-content-ads/close.gif" border="0" title="Close" align="right" WIDTH="11" HEIGHT="11" onclick="closeit()">&nbsp;</b></span></div>');
